...
**Key strategy:** The duck adds a blocking/defensive dimension to every turn. You can use your duck placement to block enemy attacks on your King, or to cut off the enemy King's escape routes before threatening capture. Planning must account for where the duck will be placed.

**Attribution:** Dr Tim Paulden, 2016. Public domain.
