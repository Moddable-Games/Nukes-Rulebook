...
**Rules:** All standard chess rules apply, plus:
...
**Win condition:** Deliver checkmate OR deliver five checks total.

**Key strategy:** Similar to Three-Check but with more breathing room. The higher threshold means you can't win by brute-force sacrificing into checks — you need sustained pressure. Pieces that deliver repeated checks (especially Queen and Rooks on open files) are strong. Trading your opponent's checking pieces while preserving your own is a key strategic layer beyond normal chess.

**Attribution:** Traditional variant (extension of Three-Check). Public domain.
