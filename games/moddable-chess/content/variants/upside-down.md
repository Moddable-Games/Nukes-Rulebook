...
**Key strategy:** Pieces are already developed — there's no opening phase of moving pieces out. Pawns are immediately adjacent to enemy pieces, creating instant tactical tension. The game is sharp from move 1. Pawn structure becomes strange because pawns are "behind" the pieces they're supposed to shield.
